<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/view/MasterPage.master" CodeFile="change.aspx.cs" Inherits="view_account_change" %>
...
<div class="form-horizontal" role="form" id="refister_form">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10" align="left">
      <asp:TextBox ID="inputID" class="form-control" Disabled placeholder="ex) HongGildong.gmail.com" runat="server" />
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10" align="left">
      <asp:TextBox class="form-control" id="inputPassword1" runat="server" 
            placeholder="글자, 숫자를 조합하여 7자리 이상" type="Password"></asp:TextBox>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10" align="left">
      <asp:textbox class="form-control" id="inputPassword2" placeholder="비밀번호와 동일하게 입력" type="Password" runat="server"></asp:textbox>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10" align="left">
      <asp:textbox class="form-control" id="inputMailNumber" runat="server" placeholder="ex) xxx-xxx"></asp:textbox>
  ...
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <asp:Button type="submit" class="btn btn-default" runat="server" Text="회원정보변경" 
            ID="btn_change" onclick="btn_change_Click"/>
    </div>
  </div>
</div>
</div>        
